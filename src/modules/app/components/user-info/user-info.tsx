...
import * as messengerIcon from "./../../../../assets/icons/FB.svg";
// import * as additionalIcon from "../../../../assets/icons/additional.svg";
      ...
      <div className={css.container}>
        ...
        <div className={css.mainInfo}>
          <div className={css.mainInfoTitle}>
            <Icon source={messengerIcon} theme={messengerIconCss} />
